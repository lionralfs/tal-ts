...
//       /** @lends antie.Application.prototype */ {
//         /**
//          * @constructor
//          * @ignore
//          */
...
//                 if (_configuration.css[i].width === _layout.width && _configuration.css[i].height === _layout.height) {
//                   _layout.css = _layout.css.concat(_configuration.css[i].files);
//                 }
//               }
//             }

//             requirejs([_layout.module], function(layout) {
...
//           completeUrl = this.getDevice()
//             .getHistorian()
//             .forward(url + query + hash);
